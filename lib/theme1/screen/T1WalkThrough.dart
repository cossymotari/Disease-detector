...
class T1WalkThrough extends StatelessWidget {
  ...
  final List<Walkthrough> list = [
    Walkthrough(title: "Camera", content: "Add Images to be detected through your camera.", imageIcon: t1_walk1),
    Walkthrough(title: "Gallery", content: "Select Images from your gallery.", imageIcon: t1_walk2),
    Walkthrough(title: "Scan Images", content: "Let the app do the scanning and get quick and accurate results.", imageIcon: t1_walk3),
  ];
