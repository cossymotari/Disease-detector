...
class LateDialog extends StatelessWidget {
  static var tag = "/LateDialog";
...
class CustomDialog2 extends StatelessWidget {
  ...
  var diseaseF2;
  var confidenceF2;
  CustomDialog2(var disease, var confidence, var disease2, var confidence2) {
        ...
        children: <Widget>[
          ...
          Padding(
              ...
              child: Column(
                children: [
                  text(
                      "Late Blight. Late blight (Phytophthora infestans) affects both tomatoes and potatoes. The disease survives over winter on volunteer potatoes (plants growing from tubers left in the ground). Spores can also blow in from nearby infected crops. In warm, wet seasons the disease spreads rapidly – it’s less of a problem in fine weather.",
